lib/codemirror.js built from tag `5.65.18` using yarn 1.22.22.
...
warning @rollup/plugin-buble > buble > magic-string > sourcemap-codec@1.4.8: Please use @jridgewell/sourcemap-codec instead
...
...and 4 more
created lib/codemirror.js in 575ms

src/addon/runmode/runmode-standalone.js → addon/runmode/runmode-standalone.js...
created addon/runmode/runmode-standalone.js in 35ms

src/addon/runmode/runmode.node.js → addon/runmode/runmode.node.js...
created addon/runmode/runmode.node.js in 30ms
Done in 12.59s.
$ npm list --depth=0
codemirror@5.65.18 /home/beni/MD/mathdown/CodeMirror
...
src/display/line_numbers.js -> src/display/update_display.js -> src/display/highlight_worker.js -> src/display/operations.js -> src/display/scrollbars.js -> src/display/scrolling.js -> src/display/line_numbers.js
...and 4 more
created lib/codemirror.js in 573ms

src/addon/runmode/runmode-standalone.js → addon/runmode/runmode-standalone.js...
created addon/runmode/runmode-standalone.js in 30ms

src/addon/runmode/runmode.node.js → addon/runmode/runmode.node.js...
created addon/runmode/runmode.node.js in 36ms
```
